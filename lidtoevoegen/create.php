...
if (isset($_POST['submit'])) {
  ...
  $sql = "SELECT * FROM LedenOverzicht WHERE Id = :Id";
...
<html lang="en">
  ...
  <body>
    <div class="container mt-3">
        ...
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6"><h3 class="text-primary">Voer een nieuwe lid in:</h3></div>
            <div class="col-3"></div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-6">
            <form action="create.php" method="POST">
                ...
                <div class="mb-3">
                    <label for="inputProgramma" class="form-label">Programma:</label>
                    <input name="Programma" placeholder="Vul een programma in" type="text" class="form-control" id="inputProgramma" value="<?= $_POST['Programma'] ?? '' ?>">
                </div>
