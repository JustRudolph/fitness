...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Medewerkers AS HAVE
            SET    HAVE.Naam = :Naam
                  ,HAVE.Tussenvoegsel = :Tussenvoegsel
 ...
 * het PDO-object. De geprepareerde sql-query stoppen we in de variabele $statement
...
<html lang="en">
  <head>
    ...
    <title>Medewerkers Update</title>
  ...
  <body>
    ...
    <div class="row">
        <div class="col-3"></div>
        <div class="col-6">
            <h3 class="text-primary">Wijzig medewerkers gegevens</h3>
        </div>
        <div class="col-3"></div>
    </div>
